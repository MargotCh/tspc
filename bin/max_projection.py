...
def max_projection(
    ...
    channels = [int(c) for c in channel_str.split(',')]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--channels", type=str, help="Comma-separated string with channels to use for projection")
    
    args = parser.parse_args()
    
    c = max_projection(
        input_path=args.input_path,
        channel_str=args.channels
    )